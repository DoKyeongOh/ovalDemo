 ...
 *         &lt;element name="auth_type" type="{http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe}EntityItemRoutingAuthTypeStringType" minOccurs="0"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="key_chain" type="{http://oval.mitre.org/XMLSchema/oval-system-characteristics-5}EntityItemStringType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RoutingprotocolauthintfItem
    extends ItemType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "auth_type", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "key_chain", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "interface", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ospf_area", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/iosxe-system-characteristics-schema.xsd占쏙옙 486占쏙옙
     ...
     * {@link JAXBElement }{@code <}{@link EntityItemRoutingAuthTypeStringType }{@code >}
