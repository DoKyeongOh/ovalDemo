...
public class ObjectFactory {
    ...
    private final static QName _RouterItemId_QNAME = new QName("http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", "id");
    ...
    private final static QName _RouterItemProtocol_QNAME = new QName("http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#iosxe", "protocol");
    ...
    public JAXBElement<EntityItemIntType> createRouterItemId(EntityItemIntType value) {
        return new JAXBElement<EntityItemIntType>(_RouterItemId_QNAME, EntityItemIntType.class, RouterItem.class, value);
    }
    ...
    public JAXBElement<EntityItemRoutingProtocolType> createRouterItemProtocol(EntityItemRoutingProtocolType value) {
        return new JAXBElement<EntityItemRoutingProtocolType>(_RouterItemProtocol_QNAME, EntityItemRoutingProtocolType.class, RouterItem.class, value);
    }
    ...
    public JAXBElement<EntityItemIntType> createRoutingprotocolauthintfItemId(EntityItemIntType value) {
        return new JAXBElement<EntityItemIntType>(_RouterItemId_QNAME, EntityItemIntType.class, RoutingprotocolauthintfItem.class, value);
    }
    ...
    public JAXBElement<EntityItemRoutingProtocolType> createRoutingprotocolauthintfItemProtocol(EntityItemRoutingProtocolType value) {
        return new JAXBElement<EntityItemRoutingProtocolType>(_RouterItemProtocol_QNAME, EntityItemRoutingProtocolType.class, RoutingprotocolauthintfItem.class, value);
    }
