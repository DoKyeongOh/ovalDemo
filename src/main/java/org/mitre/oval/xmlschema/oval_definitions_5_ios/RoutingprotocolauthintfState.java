 ...
 *         &lt;element name="protocol" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#ios}EntityStateRoutingProtocolType" minOccurs="0"/>
 *         &lt;element name="id" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateIntType" minOccurs="0"/>
 *         &lt;element name="auth_type" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#ios}EntityStateRoutingAuthTypeStringType" minOccurs="0"/>
    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "auth_type", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ospf_area", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "interface", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "key_chain", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios", type = JAXBElement.class, required = false),
     ...
     * file:/C:/work/oval/5.11.2/ios-definitions-schema.xsd占쏙옙 953占쏙옙
