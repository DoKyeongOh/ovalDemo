 ...
 *         &lt;element name="ip_version" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#ios}EntityStateAccessListIPVersionType" minOccurs="0"/>
 *         &lt;element name="use" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#ios}EntityStateAccessListUseType" minOccurs="0"/>
 *         &lt;element name="used_in" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *         &lt;element name="interface_direction" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#ios}EntityStateAccessListInterfaceDirectionType" minOccurs="0"/>
