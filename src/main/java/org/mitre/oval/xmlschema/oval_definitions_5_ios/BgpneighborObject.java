 ...
 *           &lt;sequence>
 *             &lt;element name="neighbor" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
...
public class BgpneighborObject
    extends ObjectType
{

    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
    protected Set set;
    protected EntityObjectStringType neighbor;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public EntityObjectStringType getNeighbor() {
        return neighbor;
    }

    /**
     * neighbor 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityObjectStringType }
     *     
     */
    public void setNeighbor(EntityObjectStringType value) {
        this.neighbor = value;
    }
