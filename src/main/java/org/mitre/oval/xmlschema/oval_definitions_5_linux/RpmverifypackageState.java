 ...
 *         &lt;element name="dependency_check_passed" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateBoolType" minOccurs="0"/>
 *         &lt;element name="digest_check_passed" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateBoolType" minOccurs="0"/>
 *         &lt;element name="verification_script_successful" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateBoolType" minOccurs="0"/>
 *         &lt;element name="signature_check_passed" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateBoolType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "signature_check_passed", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "dependency_check_passed", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "verification_script_successful", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "digest_check_passed", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/linux-definitions-schema.xsd占쏙옙 1731占쏙옙
