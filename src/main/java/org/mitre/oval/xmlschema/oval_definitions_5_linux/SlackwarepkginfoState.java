 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="architecture" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *         &lt;element name="revision" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "revision", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "architecture", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#linux", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/linux-definitions-schema.xsd占쏙옙 2275占쏙옙
