 ...
 *             &lt;element name="source" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    @XmlElementRef(name = "source", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#unix", type = JAXBElement.class, required = false)
    protected JAXBElement<EntityObjectStringType> source;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public JAXBElement<EntityObjectStringType> getSource() {
        return source;
    }
     ...
     *     
     */
    public void setSource(JAXBElement<EntityObjectStringType> value) {
        this.source = value;
    }
