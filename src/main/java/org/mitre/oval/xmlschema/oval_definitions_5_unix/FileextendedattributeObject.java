 ...
 *           &lt;sequence>
 *             &lt;element name="behaviors" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#unix}FileBehaviors" minOccurs="0"/>
 *             &lt;choice>
 ...
 *               &lt;/sequence>
 *             &lt;/choice>
 *             &lt;element name="attribute_name" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
...
public class FileextendedattributeObject
    extends ObjectType
{
    ...
    @XmlElementRef(name = "filename", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#unix", type = JAXBElement.class, required = false)
    protected JAXBElement<EntityObjectStringType> filename;
    @XmlElement(name = "attribute_name")
    protected EntityObjectStringType attributeName;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public EntityObjectStringType getAttributeName() {
     ...
     *     
     */
    public void setAttributeName(EntityObjectStringType value) {
