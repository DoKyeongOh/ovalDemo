 ...
 *       &lt;sequence>
 *         &lt;element name="swlist" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *         &lt;element name="bundle" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *         &lt;element name="fileset" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "title", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "vendor", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "swlist", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "bundle", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "fileset", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "version", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#hpux", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/hpux-definitions-schema.xsd占쏙옙 581占쏙옙
