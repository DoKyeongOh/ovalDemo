 ...
 *           &lt;sequence>
 *             &lt;element name="subcommand" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
...
public class XmlShowObject
    extends ObjectType
{

    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
    protected Set set;
    protected EntityObjectStringType subcommand;
     ...
     *     
     */
    public EntityObjectStringType getSubcommand() {
        return subcommand;
    }

    /**
     * subcommand 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityObjectStringType }
     *     
     */
    public void setSubcommand(EntityObjectStringType value) {
