    ...
    extends ItemType
{
    ...
    @XmlElementRef(name = "pid", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#independent", type = JAXBElement.class, required = false)
    protected JAXBElement<EntityItemIntType> pid;
     ...
     *     
     */
    public JAXBElement<EntityItemIntType> getPid() {
        return pid;
    }
     ...
     *     
     */
    public void setPid(JAXBElement<EntityItemIntType> value) {
        this.pid = value;
    }
