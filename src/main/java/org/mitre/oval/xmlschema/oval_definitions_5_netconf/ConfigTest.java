    ...
    extends TestType
{
    ...
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#netconf", required = true)
    protected ObjectRefType object;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#netconf")
