 ...
 *           &lt;sequence>
 *             &lt;element name="nvram_var" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected Set set;
    @XmlElement(name = "nvram_var")
    protected EntityObjectStringType nvramVar;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public void setNvramVar(EntityObjectStringType value) {
        this.nvramVar = value;
    }
