 ...
 *           &lt;sequence>
 *             &lt;element name="label" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
...
public class LaunchdObject
    extends ObjectType
{

    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
    protected Set set;
    protected EntityObjectStringType label;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public EntityObjectStringType getLabel() {
        return label;
    }
     ...
     *     
     */
    public void setLabel(EntityObjectStringType value) {
        this.label = value;
    }
