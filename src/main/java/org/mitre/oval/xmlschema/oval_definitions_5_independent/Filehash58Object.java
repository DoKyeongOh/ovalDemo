 ...
 *               &lt;/sequence>
 *             &lt;/choice>
 *             &lt;element name="hash_type" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#independent}EntityObjectHashTypeType"/>
    ...
    extends ObjectType
{
    ...
    protected EntityObjectHashTypeType hashType;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
    ...
    /**
     * hashType 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link EntityObjectHashTypeType }
     *     
     */
     ...
     *     
     */
    public void setHashType(EntityObjectHashTypeType value) {
        this.hashType = value;
    }
