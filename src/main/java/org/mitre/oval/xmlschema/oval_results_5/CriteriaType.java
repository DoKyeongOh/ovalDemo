 ...
 *         &lt;element name="criteria" type="{http://oval.mitre.org/XMLSchema/oval-results-5}CriteriaType"/>
 *         &lt;element name="criterion" type="{http://oval.mitre.org/XMLSchema/oval-results-5}CriterionType"/>
 *         &lt;element name="extend_definition" type="{http://oval.mitre.org/XMLSchema/oval-results-5}ExtendDefinitionType"/>
 *       &lt;/choice>
 *       &lt;attribute name="applicability_check" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 *       &lt;attribute name="operator" use="required" type="{http://oval.mitre.org/XMLSchema/oval-common-5}OperatorEnumeration" />
