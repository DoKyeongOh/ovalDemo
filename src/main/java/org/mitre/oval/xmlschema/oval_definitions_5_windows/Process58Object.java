    ...
    extends ObjectType
{
    ...
    protected Set set;
    @XmlElementRef(name = "command_line", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#windows", type = JAXBElement.class, required = false)
    protected JAXBElement<EntityObjectStringType> commandLine;
     ...
     *     
     */
    public JAXBElement<EntityObjectStringType> getCommandLine() {
        return commandLine;
    }
     ...
     *     
     */
    public void setCommandLine(JAXBElement<EntityObjectStringType> value) {
