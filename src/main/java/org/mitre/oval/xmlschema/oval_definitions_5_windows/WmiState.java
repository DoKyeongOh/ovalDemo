 ...
 *         &lt;element name="result" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateAnySimpleType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends StateType
{
    ...
    protected EntityStateAnySimpleType result;

    /**
     * namespace 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public void setResult(EntityStateAnySimpleType value) {
        this.result = value;
    }
