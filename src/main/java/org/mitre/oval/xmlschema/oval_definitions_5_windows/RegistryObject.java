 ...
 *           &lt;sequence>
 *             &lt;element name="behaviors" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}RegistryBehaviors" minOccurs="0"/>
    ...
    extends ObjectType
{
    ...
    protected JAXBElement<EntityObjectStringType> name;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public JAXBElement<EntityObjectStringType> getName() {
        return name;
    }
     ...
     *     
     */
    public void setName(JAXBElement<EntityObjectStringType> value) {
        this.name = value;
    }
