 ...
 *           &lt;sequence>
 *             &lt;element name="behaviors" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}WuaUpdateSearcherBehaviors" minOccurs="0"/>
 *             &lt;element name="search_criteria" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected EntityObjectStringType searchCriteria;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public void setSearchCriteria(EntityObjectStringType value) {
