 ...
 * 
 * <p>PackageCheckBehaviors complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "PackageCheckBehaviors")
public class PackageCheckBehaviors {
    ...
    /**
     * fileattributesOnly 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * fileattributesOnly 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
    ...
    /**
     * noVolatileeditable 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * noVolatileeditable 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
