 ...
 *           &lt;sequence>
 *             &lt;element name="service" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
 *             &lt;element name="instance" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
...
public class SmfpropertyObject
    extends ObjectType
{

    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
    protected Set set;
    protected EntityObjectStringType service;
    protected EntityObjectStringType instance;
     ...
     *     
     */
    public EntityObjectStringType getService() {
        return service;
    }

    /**
     * service 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityObjectStringType }
     *     
     */
    public void setService(EntityObjectStringType value) {
        this.service = value;
    }
     ...
     *     
     */
    public EntityObjectStringType getInstance() {
        return instance;
    }
     ...
     *     
     */
    public void setInstance(EntityObjectStringType value) {
        this.instance = value;
    }
