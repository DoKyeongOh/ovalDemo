    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "pkginst", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#solaris", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "vendor", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#solaris", type = JAXBElement.class, required = false),
     ...
     * file:/C:/work/oval/5.11.2/solaris-definitions-schema.xsd의 522행
