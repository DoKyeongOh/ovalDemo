 ...
 * &lt;complexType>
 *   &lt;complexContent>
 *     &lt;extension base="{http://oval.mitre.org/XMLSchema/oval-common-5}NotesType">
 *       &lt;sequence>
    ...
    extends NotesType
{
    ...
    @XmlElementRef(name = "note", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5", type = JAXBElement.class, required = false)
     ...
     * 필드 이름 "Note"이(가) 스키마의 다른 두 부분에 사용되었습니다. 참조: 
     * file:/C:/work/oval/5.11.2/oval-definitions-schema.xsd의 181행
     * file:/C:/work/oval/5.11.2/oval-common-schema.xsd의 189행
     * <p>
