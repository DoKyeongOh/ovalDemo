 ...
 *         &lt;element name="auth_type" type="{http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios}EntityItemRoutingAuthTypeStringType" minOccurs="0"/>
    ...
    extends ItemType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "auth_type", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "key_chain", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ospf_area", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "interface", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/ios-system-characteristics-schema.xsd占쏙옙 443占쏙옙
