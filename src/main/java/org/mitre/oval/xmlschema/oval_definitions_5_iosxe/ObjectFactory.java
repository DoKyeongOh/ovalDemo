...
public class ObjectFactory {
    ...
    private final static QName _RouterStateId_QNAME = new QName("http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", "id");
    ...
    private final static QName _RouterStateProtocol_QNAME = new QName("http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", "protocol");
    ...
    public JAXBElement<EntityStateIntType> createRouterStateId(EntityStateIntType value) {
        return new JAXBElement<EntityStateIntType>(_RouterStateId_QNAME, EntityStateIntType.class, RouterState.class, value);
    }
    ...
    public JAXBElement<EntityStateRoutingProtocolType> createRouterStateProtocol(EntityStateRoutingProtocolType value) {
        return new JAXBElement<EntityStateRoutingProtocolType>(_RouterStateProtocol_QNAME, EntityStateRoutingProtocolType.class, RouterState.class, value);
    }
    ...
    public JAXBElement<EntityStateIntType> createRoutingprotocolauthintfStateId(EntityStateIntType value) {
        return new JAXBElement<EntityStateIntType>(_RouterStateId_QNAME, EntityStateIntType.class, RoutingprotocolauthintfState.class, value);
    }
    ...
    public JAXBElement<EntityStateRoutingProtocolType> createRoutingprotocolauthintfStateProtocol(EntityStateRoutingProtocolType value) {
        return new JAXBElement<EntityStateRoutingProtocolType>(_RouterStateProtocol_QNAME, EntityStateRoutingProtocolType.class, RoutingprotocolauthintfState.class, value);
    }
    ...
    public JAXBElement<EntityObjectIntType> createRouterObjectId(EntityObjectIntType value) {
        return new JAXBElement<EntityObjectIntType>(_RouterStateId_QNAME, EntityObjectIntType.class, RouterObject.class, value);
    }
    ...
    public JAXBElement<EntityObjectRoutingProtocolType> createRouterObjectProtocol(EntityObjectRoutingProtocolType value) {
        return new JAXBElement<EntityObjectRoutingProtocolType>(_RouterStateProtocol_QNAME, EntityObjectRoutingProtocolType.class, RouterObject.class, value);
    }
