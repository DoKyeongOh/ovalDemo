 ...
 *         &lt;element name="protocol" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe}EntityStateRoutingProtocolType" minOccurs="0"/>
 *         &lt;element name="id" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateIntType" minOccurs="0"/>
 *         &lt;element name="auth_type" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe}EntityStateRoutingAuthTypeStringType" minOccurs="0"/>
 *         &lt;element name="ospf_area" minOccurs="0">
 *           &lt;complexType>
 *             &lt;simpleContent>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="key_chain" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityStateStringType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RoutingprotocolauthintfState
    extends StateType
{

    @XmlElementRefs({
        @XmlElementRef(name = "auth_type", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "ospf_area", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "key_chain", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "interface", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false)
    })
     ...
     * file:/C:/work/oval/5.11.2/iosxe-definitions-schema.xsd占쏙옙 1022占쏙옙
     ...
     * {@link JAXBElement }{@code <}{@link EntityStateRoutingAuthTypeStringType }{@code >}
     * {@link JAXBElement }{@code <}{@link EntityStateRoutingProtocolType }{@code >}
     * {@link JAXBElement }{@code <}{@link OspfArea }{@code >}
