 ...
 *           &lt;sequence>
 *             &lt;element name="global_command" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected Set set;
    @XmlElement(name = "global_command")
    protected EntityObjectStringType globalCommand;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public void setGlobalCommand(EntityObjectStringType value) {
