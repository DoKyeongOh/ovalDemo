 ...
 *         &lt;element name="priv" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe}EntityStateSNMPPrivStringType" minOccurs="0"/>
 *         &lt;element name="auth" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe}EntityStateSNMPAuthStringType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "priv", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "group", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "auth", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
     ...
     * file:/C:/work/oval/5.11.2/iosxe-definitions-schema.xsd의 1504행
