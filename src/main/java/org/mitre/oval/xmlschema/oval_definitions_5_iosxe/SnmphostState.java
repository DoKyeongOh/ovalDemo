    ...
    extends StateType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "traps", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "community_or_user", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "host", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe", type = JAXBElement.class, required = false),
     ...
     * file:/C:/work/oval/5.11.2/iosxe-definitions-schema.xsd의 1280행
