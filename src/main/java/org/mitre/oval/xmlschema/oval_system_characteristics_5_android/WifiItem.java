    ...
    extends ItemType
{
    ...
    @XmlElement(name = "network_availability_notification")
    protected EntityItemBoolType networkAvailabilityNotification;

    /**
     * wifiStatus 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
    ...
    /**
     * networkAvailabilityNotification 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link EntityItemBoolType }
    ...
    /**
     * networkAvailabilityNotification 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityItemBoolType }
