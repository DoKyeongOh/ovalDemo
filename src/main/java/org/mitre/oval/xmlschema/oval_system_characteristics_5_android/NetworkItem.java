    ...
    extends ItemType
{
    ...
    @XmlElement(name = "airplane_mode")
    protected EntityItemBoolType airplaneMode;
    @XmlElement(name = "nfc_enabled")
    protected EntityItemBoolType nfcEnabled;

    /**
     * airplaneMode 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
