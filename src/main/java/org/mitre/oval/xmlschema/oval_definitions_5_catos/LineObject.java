 ...
 *           &lt;sequence>
 *             &lt;element name="show_subcommand" type="{http://oval.mitre.org/XMLSchema/oval-definitions-5}EntityObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected Set set;
    @XmlElement(name = "show_subcommand", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#catos")
    protected EntityObjectStringType showSubcommand;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5")
     ...
     *     
     */
    public EntityObjectStringType getShowSubcommand() {
        return showSubcommand;
    }

    /**
     * showSubcommand 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityObjectStringType }
     *     
     */
    public void setShowSubcommand(EntityObjectStringType value) {
